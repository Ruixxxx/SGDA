...
def main():
    ...
    params = [{'params': net.feature_net.resnet50.layer2[0].domain_attention.parameters(), 'lr': 'lr'*10},
...
def train(net, train_loader_list, train_iters_per_epoch_list, datasets_ids, train_total_iters, optimizer, \
    ...
    for step in tqdm(range(train_total_iters)):
        ...
        torch.save({
            'epoch': 1,
            'out_dir': '/data2/users/xurui/uod_model/SGSE_SANet/SGDASANet_wt_v2drop0.2_a3_g4_results',
            'state_dict': state_dict,
            'optimizer': optimizer.state_dict()},
            os.path.join('/data2/users/xurui/uod_model/SGSE_SANet/SGDASANet_wt_v2drop0.2_bottom_top_a3_g4_results/pn9_sanet/cross_val_test_10/model/toy.ckpt'))
