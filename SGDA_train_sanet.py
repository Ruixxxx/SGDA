from net.da_sanet.DASANet import DASANet
import time
...
def main():
    ...
    ad_params = list(map(id, net.feature_net.resnet50.layer1[0].domain_attention.parameters())) + \
                list(map(id, net.feature_net.resnet50.layer1[1].domain_attention.parameters())) + \
                list(map(id, net.feature_net.resnet50.layer1[2].domain_attention.parameters())) + \
                list(map(id, net.feature_net.resnet50.layer2[0].domain_attention.parameters())) + \
    ...
    # ad_params = []
    #
    # # ad_params.extend(list(map(id, net.feature_net.resnet50.layer1[0].domain_attention.parameters())))
    # for p in net.feature_net.resnet50.layer1[0].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer1[1].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer1[2].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer2[0].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer2[2].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer2[3].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer2[5].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer3[0].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer3[2].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer3[3].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer3[5].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer3[6].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer3[8].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer4[0].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer4[1].domain_attention.parameters():
    #     ad_params.append(p)
    # for p in net.feature_net.resnet50.layer4[2].domain_attention.parameters():
    #     ad_params.append(p)

    base_params = filter(lambda p: id(p) not in ad_params, net.parameters())
    ...
    if initial_checkpoint:
        ...
        if ('model.ckpt' in initial_checkpoint):
            state = {}

            for key in checkpoint['state_dict'].keys():
                new_key = key
                if ('rpn.logits' in key) or ('rpn.deltas' in key) or ('rcnn_head' in key):
                    if '.weight' in key:
                        new_key = key.replace('.weight', '.0.weight')
                    else:
                        new_key = key.replace('.bias', '.0.bias')
                if key == 'rcnn_crop.up2.1.weight': new_key = 'rcnn_crop.up2_2.0.weight'
                if key == 'rcnn_crop.up2.1.bias': new_key = 'rcnn_crop.up2_2.0.bias'
                if key == 'rcnn_crop.up2.2.weight': new_key = 'rcnn_crop.up2_3.0.weight'
                if key == 'rcnn_crop.up2.2.bias': new_key = 'rcnn_crop.up2_3.0.bias'
                if key == 'rcnn_crop.up3.1.weight': new_key = 'rcnn_crop.up3_2.0.weight'
                if key == 'rcnn_crop.up3.1.bias': new_key = 'rcnn_crop.up3_2.0.bias'
                if key == 'rcnn_crop.up3.2.weight': new_key = 'rcnn_crop.up3_3.0.weight'
                if key == 'rcnn_crop.up3.2.bias': new_key = 'rcnn_crop.up3_3.0.bias'
                if key == 'rcnn_crop.back2.0.weight': new_key = 'rcnn_crop.back2_1.0.weight'
                if key == 'rcnn_crop.back2.0.bias': new_key = 'rcnn_crop.back2_1.0.bias'
                if key == 'rcnn_crop.back2.1.weight': new_key = 'rcnn_crop.back2_2.0.weight'
                if key == 'rcnn_crop.back2.1.bias': new_key = 'rcnn_crop.back2_2.0.bias'
                if key == 'rcnn_crop.back3.0.weight': new_key = 'rcnn_crop.back3_1.0.weight'
                if key == 'rcnn_crop.back3.0.bias': new_key = 'rcnn_crop.back3_1.0.bias'
                if key == 'rcnn_crop.back3.1.weight': new_key = 'rcnn_crop.back3_2.0.weight'
                if key == 'rcnn_crop.back3.1.bias': new_key = 'rcnn_crop.back3_2.0.bias'
