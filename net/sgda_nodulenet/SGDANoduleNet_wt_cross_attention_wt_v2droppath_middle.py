...
class DAFeatureNet(nn.Module):
  def __init__(self, config, in_channels, out_channels, net_mode):
    ...
    self.forw3_1 = DAResBlock3d_wt_cross_attention_wt_droppath(64, 64, net_mode, drop_path=dpr[0], fixed_block=fixed_block)
    self.forw3_2 = DAResBlock3d_wt_cross_attention_wt_droppath(64, 64, net_mode, drop_path=dpr[1], fixed_block=fixed_block)
    self.forw3_3 = DAResBlock3d_wt_cross_attention_wt_droppath(64, 64, net_mode, drop_path=dpr[2], fixed_block=fixed_block)

    self.forw4_1 = DAResBlock3d_wt_cross_attention_wt_droppath(64, 64, net_mode, drop_path=dpr[3], fixed_block=fixed_block)
    self.forw4_2 = DAResBlock3d_wt_cross_attention_wt_droppath(64, 64, net_mode, drop_path=dpr[4], fixed_block=fixed_block)
    self.forw4_3 = DAResBlock3d_wt_cross_attention_wt_droppath(64, 64, net_mode, drop_path=dpr[5], fixed_block=fixed_block)

    # skip connection in U-net
    self.back2_1 = ResBlock3d(128, 128)
    self.back2_2 = ResBlock3d(128, 128)
    self.back2_3 = ResBlock3d(128, 128)
      # 64 + 64 + 3, where 3 is the channeld dimension of coord

    # skip connection in U-net
    self.back3_1 = ResBlock3d(128, 64)
    self.back3_2 = ResBlock3d(64, 64)
    self.back3_3 = ResBlock3d(64, 64)
