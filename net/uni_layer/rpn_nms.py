...
def rpn_nms(cfg, mode, inputs, window, logits_flat, deltas_flat, cls_ind):
    if mode in ['train',]:
        nms_pre_score_threshold = cfg['rpn_train_nms_pre_score_threshold'][cls_ind]
        nms_overlap_threshold   = cfg['rpn_train_nms_overlap_threshold'][cls_ind]

    elif mode in ['eval', 'valid', 'test',]:
        nms_pre_score_threshold = cfg['rpn_test_nms_pre_score_threshold'][cls_ind]
        nms_overlap_threshold   = cfg['rpn_test_nms_overlap_threshold'][cls_ind]
