...
from net.da_nodulenet.NoduleNet_nomask import NoduleNet
from net.da_nodulenet.singleSENoduleNet import singleSENoduleNet
from net.sgda_nodulenet.singleSGSENoduleNet import singleSGSENoduleNet
